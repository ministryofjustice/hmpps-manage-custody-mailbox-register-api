...
class ListingMailboxesTest {
  ...
  inner class LduMailboxes : IntegrationTestBase() {
    ...
    fun `should return a list of existing mailboxes sorted by createdAt ASC`() {
      ...
      assertThat(mailboxes).hasSize(2)
      assertThat(mailboxes[0].unitCode).isEqualTo("UNIT_CODE_1")
      assertThat(mailboxes[1].unitCode).isEqualTo("UNIT_CODE_2")
    }
  }
}
